...
keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // row 3
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, /**/ SS_GG, KC_1, KC_2, KC_3, KC_TRANSPARENT, KC_TRANSPARENT,
    // row 4 & some of thumb
    ...
    LAYOUT_manuform(
    // row 1
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LSFT(KC_LBRC), LSFT(KC_RBRC), KC_TRANSPARENT, /**/ KC_TRANSPARENT, KC_EQUAL, KC_MINUS, KC_BACKSLASH, KC_TRANSPARENT, KC_TRANSPARENT,
    // row 2
