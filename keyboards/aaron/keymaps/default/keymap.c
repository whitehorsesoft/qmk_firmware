...
struct possibility possibilities[] = {{.main_keycode = KC_COMMA, .hold_keycode = S(KC_SLASH)}
...
keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // row 2
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, /**/ LSFT(KC_I), KC_LEFT, KC_DOWN, KC_RIGHT, SS_APPEND, KC_TRANSPARENT,
    // row 3
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LSFT, KC_LCTL, KC_NO, KC_TRANSPARENT, /**/ LSFT(KC_5), KC_B, KC_W, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    // row 4 & some of thumb
    ...
    LAYOUT_manuform(
    // row 1
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, /**/ LSFT(KC_EQUAL), KC_7, KC_8, KC_9, KC_SLASH, KC_TRANSPARENT,
    // row 2
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, /**/ KC_MINUS, KC_4, KC_5, KC_6, LSFT(KC_8), KC_TRANSPARENT,
    // row 3
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, /**/ SS_GG, KC_1, KC_2, KC_3, KC_EQUAL, KC_TRANSPARENT,
    // row 4 & some of thumb
    ...
    LAYOUT_manuform(
    // row 1
    KC_TRANSPARENT, KC_TRANSPARENT, LSFT(KC_SLASH), LSFT(KC_LBRC), LSFT(KC_RBRC), KC_TRANSPARENT, /**/ KC_TRANSPARENT, KC_EQUAL, KC_MINUS, KC_BACKSLASH, KC_TRANSPARENT, KC_TRANSPARENT,
    // row 2
    KC_TRANSPARENT, KC_LBRC, KC_RBRC, LSFT(KC_9), LSFT(KC_0), SS_APPEND_SEMI, /**/ KC_TRANSPARENT, LSFT(KC_EQUAL), LSFT(KC_MINUS), LSFT(KC_BACKSLASH), LSFT(KC_2), KC_TRANSPARENT,
    // row 3
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case SS_APPEND_SEMI:
            if (record->event.pressed) {
                SEND_STRING_DELAY(SS_TAP(X_ESC)
                "A;"
                SS_TAP(X_ESC), 100);
            }
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (host_keyboard_led_state().caps_lock) {
        ...
        rgb_matrix_set_color_all(
                red_subdued_rgb.r, red_subdued_rgb.g, red_subdued_rgb.b
        );
...
void keyboard_post_init_user(void) {
    rgb_matrix_mode_noeeprom(RGB_MATRIX_SOLID_REACTIVE);
    // this sets the base color
    rgb_matrix_sethsv_noeeprom(40, 100, 20);
}
